...
module bnn_cfg_header_parser_dp (
    ...
    // ─── Section A: Header shift register ───────────────────────────────
    ...
    // ─── Section B: Header byte counter (0..15) ─────────────────────────
    ...
    // ─── Section C: Header field extraction (combinational) ─────────────
    // Byte 0 arrived first → after 16 right-shifts, byte 0 is at [7:0]
    ...
    // ─── Section D: Total bytes latch + payload byte counter ─────────────
